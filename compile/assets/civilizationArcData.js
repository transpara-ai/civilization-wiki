  ...
  window.CIVILIZATION_ARC_DATA = {
    ...
    items: [
      ...
      },
      {
        id: "gate-e",
        type: "gate",
        label: "Gate-E or new grant decision pending",
        status: "active",
        blocked: true,
        blocked_reason: "gate",
        provenance: "reconstructed",
        ...
        deps: [],
        href: "gate-k.html",
        note: "Gate-E / grant decision is pending; deployment is not authorized by the wiki.",
      },
      {
        id: "gate-k",
        type: "gate",
        label: "Loop-hardening gate defined and unsatisfied",
        status: "active",
        blocked: true,
        blocked_reason: "gate",
        provenance: "reconstructed",
      ...
      // ── ExecutionPlan — nearTerm N1–N6 ───────────────────────────────
      // Placed in the late arc. Done/active items: seq ≤ 13.89 (left of/at frontier 13.9).
      // N3 is blocked → status:active + blocked:true.
      // N4, N5 are 'next' → status:planned (seq > 13.9).
      // N6 is 'planned' → status:planned (seq > 13.9).
      {
        id: "n1",
        type: "work",
      ...
      },
      {
        ...
        note: "Authority is recorded, and the Gate-K packet is either merged, revised, or explicitly rejected.",
      },
      {
        id: "n4",
        type: "work",
        ...
        deps: ["n3"],
        href: "gate-k.html",
        note: "Data handling, review prompts, and loop-hardening conventions are canonical after the grant decision.",
      },
      {
        id: "n5",
        type: "work",
        ...
        deps: ["n3"],
        href: "v4-0.html",
        note: "Current docs route to v4.0 as the operative baseline and retain v3.9 as closed history.",
      },
      {
        id: "n6",
        type: "work",
        ...
        deps: ["n4", "n5"],
        href: "the-observatory.html",
        note: "The UI shows PR, check, authority, heartbeat, and review-loop state from live sources.",
      },
