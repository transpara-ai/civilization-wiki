...
This article is about **our catalog and how it sits in the investigation**, not a mirror of any upstream's documentation. The patterns it distils trace to public, lovyou-ai-adjacent OSS (chiefly Garry Tan's `gstack`, MIT); those upstreams are cited here as context only, never re-published.
