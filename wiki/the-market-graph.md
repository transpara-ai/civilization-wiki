...
sources:
  ...
  - /Transpara/transpara-ai/data/repos/docs/dark-factory/all-posts 1.md  # first-party copy of the Searles corpus; same text + cross-graph references (escrow/reputation/identity touch-points; worked cross-graph dispute example L2065)
confidence:
