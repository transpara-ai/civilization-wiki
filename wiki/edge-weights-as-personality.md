...
- **Built on:** [[200-primitives]] and [[the-quartet]] — the claim "everyone has all the primitives; only the edge weights differ" is the premise the architecture proposal depends on.
